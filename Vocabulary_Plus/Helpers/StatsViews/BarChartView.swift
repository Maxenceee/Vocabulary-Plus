...
class ChartBarView: UIView, ChartViewDelegate {
    ...
    override func draw(_ rect: CGRect) {
        ...
        barChart.frame = CGRect(x: 10, y: 10, width: self.frame.size.width-10, height: self.frame.size.height-10)
...
//        getStatistics()
        ...
        for i in 0..<10 {
            entries.append(BarChartDataEntry(x: Double(i), y: Double(i+Int.random(in: -3...3))))
        }
